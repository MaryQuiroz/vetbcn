...
export default function FavoritesDrawer({ clinics, isOpen, onClose }: Props) {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className={`fixed inset-y-0 right-0 z-50 flex w-full sm:w-auto sm:max-w-sm flex-col bg-white shadow-2xl transition-transform duration-300 ${isOpen ? "translate-x-0" : "translate-x-full"}`}>
        {/* Header */}
